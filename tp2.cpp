...
bool init_program( )
{
    ...
    std::string fragment_source= read("/Users/crymsius/gkit2light/src/shader/tp2GL_fragment.glsl");
    ...
    //program_uniform(program, "translation", 0.3f);
    
    //Transform translationMatrix = 0.3 * Transform();
    //program_uniform(program, "translationMatrix", translationMatrix);
    
    //program_uniform(program, "rotationMatrix", Transform());
    
    Transform mvpMatrix = RotationZ(30)*Translation(Vector(0,0,1));
